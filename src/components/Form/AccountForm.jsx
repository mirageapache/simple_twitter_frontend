  ...
  return(
    <div className='form'>
      <div className='input_group'>
        <FormInput title='帳號' name='account' type='text' placeholder='請輸入帳號' value={accout} />
        <FormInput title='名稱' name='name' type='text' placeholder='請輸入使用者名稱' />
        <FormInput title='Email' name='email' type='email' placeholder='請輸入Email' />
        <FormInput title='密碼' name='passowrd' type='password' placeholder='請設定密碼' />
